...
public class Retezce_indexy {
    public static void main(String[] args) {
        ...
        String text = "Skákal pes přes oves";
        if (text.contains("pes")){
            System.out.println("Ano");
        }else System.out.println("Ne");

        //indexOf a lastIndexOf vrací index znaku ve stringu - pokud ten znak není ve stringu tak vrací hodnotu -1
        ...
        //contains() - prostě jestli to obsahuje
        //třída Character - primitivní, znaky do apostrofů
        //charAt() - volá se na stringu a vrací char
        //isLetter - testuje zda-li znak je písmeno
        //isDigit - jasný
        //isUpperCase/isLowerCase
        //toString - převede na string
    }
}
